...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public CustomUserDetailsService(com.acquira.common.repository.UserRepository userRepository,
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        List<com.acquira.common.model.UserTenantAccess> accessList = userTenantAccessRepository.findByUser(user);

        // Determine Roles based on Groups
        java.util.Set<String> roles = new java.util.HashSet<>();
        roles.add("ROLE_USER"); // Default

        for (com.acquira.common.model.UserTenantAccess access : accessList) {
