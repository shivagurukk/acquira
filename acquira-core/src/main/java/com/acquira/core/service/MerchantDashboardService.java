...
import com.acquira.common.dto.DailyMerchantDashboardDTO;
...
public class MerchantDashboardService {
    ...
    @Autowired
    private com.acquira.common.repository.MerchantRepository merchantRepo;
    ...
    public List<DailyMerchantDashboardDTO> getDailyDashboard(Integer tenantId, int month, int year) {
        ...
        List<com.acquira.common.model.Merchant> merchants = merchantRepo.findAllById(merchantIds);
        Map<Long, com.acquira.common.model.Merchant> merchantMap = merchants.stream()
                .collect(Collectors.toMap(com.acquira.common.model.Merchant::getMerchantId, m -> m));
        ...
        for (Map.Entry<Long, List<SumDailyMerchant>> entry : groupedByMerchant.entrySet()) {
            ...
            com.acquira.common.model.Merchant mDetails = merchantMap.get(merchantId);
