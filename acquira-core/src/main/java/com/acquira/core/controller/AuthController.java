...
public class AuthController {
    ...
    public ResponseEntity<?> createAuthenticationToken(
        ...
        com.acquira.common.model.User user = userRepository.findByUsername(authenticationRequest.getUsername()).orElse(null);
    ...
    public ResponseEntity<?> refreshToken(@RequestBody Map<String, String> payload) {
        ...
        try {
            ...
            com.acquira.common.model.User dbUser = userRepository.findByUsername(username).orElse(null);
